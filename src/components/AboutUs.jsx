...
const PromoVideoShowcase = dynamic(
  () => import("@/components/PromoVideoShowcase"),
  {
    ssr: false,
          ...
          >
            <motion.div variants={fadeInUp} className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                We empower businesses with digital solutions that drive growth.
                Through web development, SEO, social media, Google presence, and
                content, we help clients thrive.
              </p>
        ...
        >
          <div className="p-8 md:p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeInUp} className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                We combine innovative strategies with analytics for SEO,
                content, and social media to help businesses grow.
              </p>
