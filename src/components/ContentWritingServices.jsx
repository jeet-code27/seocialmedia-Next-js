        ...
        <div className="px-4 py-16 md:px-16 lg:px-24">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="mt-5 text-gray-600 text-base md:text-lg max-w-3xl mx-auto">
                Transform your digital presence with SEO-optimized, engaging content that
                connects with your audience and drives measurable business growth
              </p>
            </div>
