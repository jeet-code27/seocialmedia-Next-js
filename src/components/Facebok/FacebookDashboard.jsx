...
const FacebookIntegration = () => {
  ...
  const authToken =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4YzUwZjljYWIwZDQ2NjUwZmZiOTQxNSIsImlhdCI6MTc1ODc4NDg1MywiZXhwIjoxNzU5Mzg5NjUzfQ.keAMe1gRcCnBuIs5gDgJnQZQs6GhPST-0uRYXxRa2kY";
            ...
            <div className=" rounded-lg p-8 flex items-center space-x-4 shadow-xl">
              ...
              {/* <div>
                <h3 className="text-gray-900 font-semibold">
                  ...
                  {insightsLoading && 'Loading Page Insights...'}
                  {postsLoading && 'Loading Page Posts...'}
                </h3>
